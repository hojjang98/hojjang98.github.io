...
```
week_18/
├── 리베로_WBS_하랑케이터링_v1.0.xlsx        # WBS
├── 하랑케이터링_점검보고서.docx              # 점검보고서 초안
└── 증적자료/
    ├── 01_특수식_출력물_관리현황.html         # 물리적 출력물 현장 실사
    ├── 02_공용계정_점검결과.html              # 계정 관리 점검
    ├── 03_ERP_로그_점검결과.html              # 접속기록 점검
    ├── 04_교육이수_현황.html                  # 개인정보보호 교육 이수
    └── 05_개인정보파기_현황.html              # 파기 절차 점검
```
