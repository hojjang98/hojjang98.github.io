...
[이 논문 시기 - 2020년]:
최초 SLR로 개념 틀 제시
5가지 리스크 유형 / 3차원 PoP / 3단계 전파 모델
IT-조직-공급망 보안 통합 모델

        ↓

[현재 - 2024-2026년]:
소프트웨어 공급망 공격의 부상 (SolarWinds, XZ Utils)
NIST C-SCRM 프레임워크 강화
공급망 보안 규제 확대 (EU Cyber Resilience Act)
제로트러스트(Zero-trust) 아키텍처의 공급망 적용
```
