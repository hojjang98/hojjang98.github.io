...
date: 2025-12-18
draft: false
tags: ["웹해킹", "BurpSuite", "GoogleDork", "OWASP", "WebGoat", "보안관제", "SK쉴더스루키즈"]
categories: ["daily-logs"]
summary: "웹 해킹 역사, 정보 수집 기법(Burp Suite/Google Dork/Wikto), OWASP Top 10 (2021), WebGoat 실습 환경 구축"
---
...
|:---:|:---|:---|:---|
| **정보 수집** | - 단시간 대량 404 에러<br>- /admin, /backup 등 민감 경로 접근<br>- OPTIONS 메서드 사용 | `192.168.1.100 - [18/Dec/2024:10:23:45] "GET /admin/ HTTP/1.1" 404`<br>`192.168.1.100 - [18/Dec/2024:10:23:46] "GET /backup/ HTTP/1.1" 404` | - Rate Limiting 적용<br>- 스캐너 User-Agent 차단<br>- IP 임시 차단 |
